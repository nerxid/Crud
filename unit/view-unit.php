...
<body>
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="text" class="form-control" name="unitname" id="unitname" value="<?php echo $unitnameList[$i]; ?>" readonly>
            <br>
            <label for="statusid" class="form-add">Select Status</label>
                ...
                ?>
                <label for="statusid" class="form-add">Status</label>
                <input type="text" class="form-control" name="statusname" id="unitname" value="<?php echo $rows['statusname']; ?>" readonly>
                <?php
                    }} ?>
              <br>
